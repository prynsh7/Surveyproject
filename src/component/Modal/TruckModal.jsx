...
import "./Modal.scss"
import { ADD_PRODUCT, GET_TRUCK } from '../../utils/apiConstant';
...
function TruckModal({ showModal, setShowModal, data, setData, setTrigger }) {
    ...
    const handleUpdate = async () => {
        ...
        await axios.put(`${GET_TRUCK}/${data.id}`, obj)
            .then(res => {
                        ...
                        <div className="row">
                            <div className="col">
                                <label className="input-lebel">
                                    Status = PENDING, ORDERED, DELETED
                                </label>
